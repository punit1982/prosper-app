...
if current_step == 1:
    st.markdown(
        ...
        "<p style='color:var(--p-ink-3);font-size:1.2rem;margin-top:4px'>"
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # ── Option 3: Add Manually Later ─────────────────────────────────────────
        ...
        st.markdown(
            "<div style='padding:16px;border-radius:12px;border:1px solid #333;color:var(--p-ink-3)'>"
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with row1_c1:
        st.markdown(
            ...
            "<div style='color:var(--p-ink-3);font-size:0.9rem'>Your portfolio at a glance with AI briefing</div>"
            "</div>",
            unsafe_allow_html=True,
        )
    ...
    with row1_c2:
        st.markdown(
            ...
            "<div style='color:var(--p-ink-3);font-size:0.9rem'>14-section PROSPER analysis for any stock</div>"
            "</div>",
            unsafe_allow_html=True,
        )
    ...
    with row2_c1:
        st.markdown(
            ...
            "<div style='color:var(--p-ink-3);font-size:0.9rem'>FORTRESS risk engine with position guidance</div>"
            "</div>",
            unsafe_allow_html=True,
        )
    ...
    with row2_c2:
        st.markdown(
            ...
            "<div style='color:var(--p-ink-3);font-size:0.9rem'>Chat with AI about your portfolio</div>"
            "</div>",
            unsafe_allow_html=True,
        )
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        "<p style='color:var(--p-ink-3);font-size:1.1rem;margin-top:8px'>"
    ...
    with _center:
        ...
        if st.button("Go to Command Center", type="primary", use_container_width=True):
            ...
            st.session_state.onboarding_step = 1
            st.switch_page("views/00_Command_Center.py")
